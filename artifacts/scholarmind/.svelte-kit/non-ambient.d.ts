...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/admin" | "/ai" | "/auth" | "/auth/callback" | "/chat" | "/crisis" | "/dashboard" | "/deep-work" | "/demo" | "/import" | "/login" | "/privacy-vault" | "/profile" | "/reflections" | "/register" | "/rooms" | "/schedule" | "/sessions" | "/settings" | "/settings/connectors" | "/settings/theme" | "/study" | "/university" | "/vault";
		RouteParams(): {
		...
		LayoutParams(): {
			...
			"/reflections": Record<string, never>;
			...
			"/university": Record<string, never>;
